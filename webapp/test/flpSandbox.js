		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comodatacrudoperationscapodatacrudoperations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comodatacrudoperationscapodatacrudoperations-display": {
								"semanticObject": "comodatacrudoperationscapodatacrudoperations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.odatacrudoperations.capodatacrudoperations",
									"url": sap.ui.require.toUrl("com/odatacrudoperations/capodatacrudoperations")
								}
							}
						}
					}
